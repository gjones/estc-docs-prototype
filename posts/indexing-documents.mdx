---
title: Indexing Documents | Elasticsearch-PHP
description: Indexing Documents | Elasticsearch-PHP
date: '2020-12-18'
excerpt: 'Indexing Documents When you add documents to Elasticsearch, you index JSON documents. This maps naturally to PHP associati...'
icon: 'logoElasticsearch'
tags: ['ingesting data', 'elasticsearch', 'php']
---
