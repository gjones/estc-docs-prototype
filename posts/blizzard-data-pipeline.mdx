---
title: Blizzard - Building a Near Real-Time Data Pipeline
description: Blizzard - Building a Near Real-Time Data Pipeline
date: '2020-12-18'
excerpt: 'Share how they leverage Elasticsearch, Logstash, Kafka, Kibana, tribes, and Node.js to generate actionable value from gamer an...'
icon: 'logoElasticsearch'
tags: ['ingesting data', 'nodejs', 'elasticsearch', 'logstash']
---
